    ...
    <main>
            ...
            <div class="relative mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:py-16 lg:grid-cols-[minmax(0,0.92fr)_minmax(520px,1fr)] lg:px-8 lg:py-20">
                <div class="flex flex-col justify-center">
                    ...
                    <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                        <a href={isAuthenticated ? appHref : '/register?plan=starter&intent=trial'} class="inline-flex h-11 items-center justify-center rounded-md bg-[#103d3a] px-5 text-sm font-semibold text-white shadow-sm hover:bg-[#0b2f2c]">
                            {isAuthenticated ? 'Buka dashboard' : 'Mulai trial gratis'} <ArrowRight class="ml-2 h-4 w-4" />
                        </a>
        ...
        <section class="border-t border-[#d9ded4] bg-[#103d3a]">
            <div class="mx-auto grid max-w-7xl gap-8 px-4 py-12 text-white sm:px-6 md:grid-cols-[1fr_auto] md:items-center lg:px-8">
                ...
                <a href={isAuthenticated ? appHref : '/register?plan=starter&intent=trial'} class="inline-flex h-11 items-center justify-center rounded-md bg-white px-5 text-sm font-semibold text-[#103d3a] hover:bg-[#eef2eb]">
                    {isAuthenticated ? 'Buka dashboard' : 'Mulai trial'} <ArrowRight class="ml-2 h-4 w-4" />
                </a>
            </div>
        </section>
    </main>
