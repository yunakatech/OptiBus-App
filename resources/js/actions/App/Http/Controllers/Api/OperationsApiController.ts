 ...
 * @see app/Http/Controllers/Api/OperationsApiController.php:24
 ...
 * @see app/Http/Controllers/Api/OperationsApiController.php:40
 ...
 * @see app/Http/Controllers/Api/OperationsApiController.php:79
 ...
 * @see app/Http/Controllers/Api/OperationsApiController.php:97
 ...
 * @see app/Http/Controllers/Api/OperationsApiController.php:133
 ...
 * @see app/Http/Controllers/Api/OperationsApiController.php:219
...
/**
* @see \App\Http\Controllers\Api\OperationsApiController::luggageOptions
 * @see app/Http/Controllers/Api/OperationsApiController.php:238
 * @route '/api/master/luggage-options'
 */
export const luggageOptions = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: luggageOptions.url(options),
    method: 'get',
})

luggageOptions.definition = {
    methods: ["get","head"],
    url: '/api/master/luggage-options',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/api/master/luggage-options'
 */
luggageOptions.url = (options?: RouteQueryOptions) => {
    return luggageOptions.definition.url + queryParams(options)
}
 ...
 * @route '/api/master/luggage-options'
 */
luggageOptions.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: luggageOptions.url(options),
    method: 'get',
})
/**
 ...
 * @route '/api/master/luggage-options'
 */
luggageOptions.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: luggageOptions.url(options),
    method: 'head',
})
 ...
 * @route '/api/master/luggage-options'
 */
    const luggageOptionsForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: luggageOptions.url(options),
        method: 'get',
    })
 ...
 * @route '/api/master/luggage-options'
 */
        luggageOptionsForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: luggageOptions.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/master/luggage-options'
 */
        luggageOptionsForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: luggageOptions.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    luggageOptions.form = luggageOptionsForm
/**
* @see \App\Http\Controllers\Api\OperationsApiController::searchCustomers
 * @see app/Http/Controllers/Api/OperationsApiController.php:299
 ...
 * @see app/Http/Controllers/Api/OperationsApiController.php:406
 ...
 * @see app/Http/Controllers/Api/OperationsApiController.php:478
...
const OperationsApiController = { charterRoutes, segments, segmentPrice, units, armadas, drivers, luggageServices, luggageOptions, searchCustomers, submitCharter, submitLuggage }
