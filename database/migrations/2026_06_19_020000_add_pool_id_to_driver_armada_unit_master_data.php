...
return new class extends Migration
{
    ...
    {
        foreach (['drivers', 'armadas', 'units'] as $tableName) {
            ...
            if (! Schema::hasColumn($tableName, 'pool_id')) {
                Schema::table($tableName, function (Blueprint $table) use ($tableName): void {
                    $column = $table->unsignedBigInteger('pool_id')->nullable();
        ...
        $this->backfillPools('drivers');
        $this->backfillPools('armadas');
        $this->backfillPools('units');
    }
    ...
    {
        if (! Schema::hasTable($tableName) || ! Schema::hasColumn($tableName, 'pool_id') || ! Schema::hasTable('pools')) {
            return;
        }
