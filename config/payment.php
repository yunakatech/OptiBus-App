...
return [
    ...
    | Nominal QRIS statis sebenarnya — nominal dinamis ditampilkan
    | sebagai label teks di atas QR.
    |
    */
    'qris' => [
        'enabled' => env('PAYMENT_QRIS_ENABLED', true),
        'merchant_name' => env('PAYMENT_QRIS_MERCHANT_NAME', 'Qbus Indonesia'),
    ...
    'bank_transfer' => [
        ...
        'accounts' => [
            [
                ...
                'account_holder' => env('PAYMENT_BANK_1_HOLDER', 'PT Qbus Indonesia'),
            ...
            [
                ...
                'account_holder' => env('PAYMENT_BANK_2_HOLDER', 'PT Qbus Indonesia'),
                'note' => 'Transfer sesuai nominal paket dan upload bukti.',
            ],
            [
                'bank_name' => env('PAYMENT_BANK_3_NAME', 'Mandiri'),
                'account_number' => env('PAYMENT_BANK_3_NUMBER', '1122334455'),
                'account_holder' => env('PAYMENT_BANK_3_HOLDER', 'PT Qbus Indonesia'),
                'note' => 'Transfer sesuai nominal paket dan upload bukti.',
            ],
        ],
    ],
